module.exports=[5310,e=>e.a(async(t,a)=>{try{var n=e.i(89171),r=e.i(38895),s=e.i(33405),i=e.i(22734),d=t([r]);[r]=d.then?(await d)():d;let o="/tmp/edudesk-update.log",l="/tmp/edudesk-update.lock";async function E(){let{error:e}=await (0,r.requireAuth)(["TENANT_ADMIN"]);if(e)return e;let t=i.default.existsSync(l);return n.NextResponse.json({running:t})}async function A(){let{error:e}=await (0,r.requireAuth)(["TENANT_ADMIN"]);if(e)return e;if(i.default.existsSync(l))return n.NextResponse.json({error:"An update is already in progress"},{status:409});i.default.writeFileSync(o,""),i.default.writeFileSync(l,String(Date.now()));let t=`#!/bin/bash
set -e
LOG="${o}"
LOCK="${l}"
...
`,a="/tmp/edudesk-update-run.sh";return i.default.writeFileSync(a,t,{mode:493}),(0,s.spawn)("bash",[a],{detached:!0,stdio:"ignore"}).unref(),n.NextResponse.json({started:!0})}e.s(["GET",()=>E,"POST",()=>A]),a()}catch(e){a(e)}},!1),25734,e=>e.a(async(t,a)=>{try{var n=e.i(47909),r=e.i(74017),s=e.i(96250),i=e.i(59756),d=e.i(61916),E=e.i(74677),A=e.i(69741),o=e.i(16795),l=e.i(87718),T=e.i(95169),u=e.i(47587),L=e.i(66012),N=e.i(70101),R=e.i(26937),c=e.i(70909),p=e.i(93695);e.i(52474);var C=e.i(220),m=e.i(5310),D=t([m]);[m]=D.then?(await D)():D;let I=new n.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/system/update/route",pathname:"/api/system/update",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/system/update/route.ts",nextConfigOutput:"",userland:m}),{workAsyncStorage:U,workUnitAsyncStorage:S,serverHooks:g}=I;function O(){return(0,s.patchFetch)({workAsyncStorage:U,workUnitAsyncStorage:S})}async function _(e,t,a){I.isDev&&(0,i.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/system/update/route";n=n.replace(/\/index$/,"")||"/";let s=await I.prepare(e,t,{srcPage:n,multiZoneDraftMode:!1});if(!s)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:m,params:D,nextConfig:O,parsedUrl:_,isDraftMode:U,prerenderManifest:S,routerServerContext:g,isOnDemandRevalidate:f,revalidateOnlyGenerated:h,resolvedPathname:M,clientReferenceManifest:y,serverActionsManifest:P}=s,k=(0,A.normalizeAppPath)(n),v=!!(S.dynamicRoutes[k]||S.routes[M]),q=async()=>((null==g?void 0:g.render404)?await g.render404(e,t,_,!1):t.end("This page could not be found"),null);if(v&&!U){let e=!!S.routes[M],t=S.dynamicRoutes[k];if(t&&!1===t.fallback&&!e){if(O.experimental.adapterPath)return await q();throw new p.NoFallbackError}}let F=null;!v||I.isDev||U||(F=M,F="/index"===F?"/":F);let H=!0===I.isDev||!v,x=v&&!H;P&&y&&(0,E.setManifestsSingleton)({page:n,clientReferenceManifest:y,serverActionsManifest:P});let b=e.method||"GET",w=(0,d.getTracer)(),$=w.getActiveScopeSpan(),B={params:D,prerenderManifest:S,renderOpts:{experimental:{authInterrupts:!!O.experimental.authInterrupts},cacheComponents:!!O.cacheComponents,supportsDynamicResponse:H,incrementalCache:(0,i.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:O.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,n,r)=>I.onRequestError(e,t,n,r,g)},sharedContext:{buildId:m}},G=new o.NodeNextRequest(e),V=new o.NodeNextResponse(t),K=l.NextRequestAdapter.fromNodeNextRequest(G,(0,l.signalFromNodeResponse)(t));try{let s=async e=>I.handle(K,B).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=w.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==T.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${b} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${b} ${n}`)}),E=!!(0,i.getRequestMeta)(e,"minimalMode"),A=async i=>{var d,A;let o=async({previousCacheEntry:r})=>{try{if(!E&&f&&h&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await s(i);e.fetchMetrics=B.renderOpts.fetchMetrics;let d=B.renderOpts.pendingWaitUntil;d&&a.waitUntil&&(a.waitUntil(d),d=void 0);let A=B.renderOpts.collectedTags;if(!v)return await (0,L.sendResponse)(G,V,n,B.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,N.toNodeOutgoingHttpHeaders)(n.headers);A&&(t[c.NEXT_CACHE_TAGS_HEADER]=A),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==B.renderOpts.collectedRevalidate&&!(B.renderOpts.collectedRevalidate>=c.INFINITE_CACHE)&&B.renderOpts.collectedRevalidate,r=void 0===B.renderOpts.collectedExpire||B.renderOpts.collectedExpire>=c.INFINITE_CACHE?void 0:B.renderOpts.collectedExpire;return{value:{kind:C.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==r?void 0:r.isStale)&&await I.onRequestError(e,t,{routerKind:"App Router",routePath:n,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:x,isOnDemandRevalidate:f})},!1,g),t}},l=await I.handleResponse({req:e,nextConfig:O,cacheKey:F,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:S,isRoutePPREnabled:!1,isOnDemandRevalidate:f,revalidateOnlyGenerated:h,responseGenerator:o,waitUntil:a.waitUntil,isMinimalMode:E});if(!v)return null;if((null==l||null==(d=l.value)?void 0:d.kind)!==C.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(A=l.value)?void 0:A.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});E||t.setHeader("x-nextjs-cache",f?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),U&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let T=(0,N.fromNodeOutgoingHttpHeaders)(l.value.headers);return E&&v||T.delete(c.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||t.getHeader("Cache-Control")||T.get("Cache-Control")||T.set("Cache-Control",(0,R.getCacheControlHeader)(l.cacheControl)),await (0,L.sendResponse)(G,V,new Response(l.value.body,{headers:T,status:l.value.status||200})),null};$?await A($):await w.withPropagatedContext(e.headers,()=>w.trace(T.BaseServerSpan.handleRequest,{spanName:`${b} ${n}`,kind:d.SpanKind.SERVER,attributes:{"http.method":b,"http.target":e.url}},A))}catch(t){if(t instanceof p.NoFallbackError||await I.onRequestError(e,t,{routerKind:"App Router",routePath:k,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:x,isOnDemandRevalidate:f})},!1,g),v)throw t;return await (0,L.sendResponse)(G,V,new Response(null,{status:500})),null}}e.s(["handler",()=>_,"patchFetch",()=>O,"routeModule",()=>I,"serverHooks",()=>g,"workAsyncStorage",()=>U,"workUnitAsyncStorage",()=>S]),a()}catch(e){a(e)}},!1)];
