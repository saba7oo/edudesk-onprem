module.exports=[5310,e=>e.a(async(t,a)=>{try{var n=e.i(89171),s=e.i(38895),E=e.i(33405),r=e.i(22734),i=t([s]);[s]=i.then?(await i)():i;let d="/tmp/edudesk-update.log",o="/tmp/edudesk-update.lock";async function A(){let{error:e}=await (0,s.requireAuth)(["TENANT_ADMIN"]);if(e)return e;let t=r.default.existsSync(o);return n.NextResponse.json({running:t})}async function T(){let{error:e}=await (0,s.requireAuth)(["TENANT_ADMIN"]);if(e)return e;if(r.default.existsSync(o))return n.NextResponse.json({error:"An update is already in progress"},{status:409});r.default.writeFileSync(d,""),r.default.writeFileSync(o,String(Date.now()));let t=`#!/bin/bash
set -e
LOG="${d}"
LOCK="${o}"
...
`,a="/tmp/edudesk-update-run.sh";return r.default.writeFileSync(a,t,{mode:493}),(0,E.spawn)("bash",[a],{detached:!0,stdio:"ignore"}).unref(),n.NextResponse.json({started:!0})}e.s(["GET",()=>A,"POST",()=>T]),a()}catch(e){a(e)}},!1),25734,e=>e.a(async(t,a)=>{try{var n=e.i(47909),s=e.i(74017),E=e.i(96250),r=e.i(59756),i=e.i(61916),A=e.i(74677),T=e.i(69741),d=e.i(16795),o=e.i(87718),L=e.i(95169),l=e.i(47587),N=e.i(66012),R=e.i(70101),u=e.i(26937),c=e.i(70909),C=e.i(93695);e.i(52474);var D=e.i(220),p=e.i(5310),O=t([p]);[p]=O.then?(await O)():O;let _=new n.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/system/update/route",pathname:"/api/system/update",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/system/update/route.ts",nextConfigOutput:"",userland:p}),{workAsyncStorage:m,workUnitAsyncStorage:S,serverHooks:f}=_;function U(){return(0,E.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:S})}async function I(e,t,a){_.isDev&&(0,r.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/system/update/route";n=n.replace(/\/index$/,"")||"/";let E=await _.prepare(e,t,{srcPage:n,multiZoneDraftMode:!1});if(!E)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:p,params:O,nextConfig:U,parsedUrl:I,isDraftMode:m,prerenderManifest:S,routerServerContext:f,isOnDemandRevalidate:g,revalidateOnlyGenerated:M,resolvedPathname:h,clientReferenceManifest:y,serverActionsManifest:k}=E,P=(0,T.normalizeAppPath)(n),F=!!(S.dynamicRoutes[P]||S.routes[h]),H=async()=>((null==f?void 0:f.render404)?await f.render404(e,t,I,!1):t.end("This page could not be found"),null);if(F&&!m){let e=!!S.routes[h],t=S.dynamicRoutes[P];if(t&&!1===t.fallback&&!e){if(U.experimental.adapterPath)return await H();throw new C.NoFallbackError}}let v=null;!F||_.isDev||m||(v=h,v="/index"===v?"/":v);let q=!0===_.isDev||!F,b=F&&!q;k&&y&&(0,A.setManifestsSingleton)({page:n,clientReferenceManifest:y,serverActionsManifest:k});let B=e.method||"GET",w=(0,i.getTracer)(),$=w.getActiveScopeSpan(),x={params:O,prerenderManifest:S,renderOpts:{experimental:{authInterrupts:!!U.experimental.authInterrupts},cacheComponents:!!U.cacheComponents,supportsDynamicResponse:q,incrementalCache:(0,r.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:U.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,n,s)=>_.onRequestError(e,t,n,s,f)},sharedContext:{buildId:p}},G=new d.NodeNextRequest(e),V=new d.NodeNextResponse(t),X=o.NextRequestAdapter.fromNodeNextRequest(G,(0,o.signalFromNodeResponse)(t));try{let E=async e=>_.handle(X,x).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=w.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==L.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let s=a.get("next.route");if(s){let t=`${B} ${s}`;e.setAttributes({"next.route":s,"http.route":s,"next.span_name":t}),e.updateName(t)}else e.updateName(`${B} ${n}`)}),A=!!(0,r.getRequestMeta)(e,"minimalMode"),T=async r=>{var i,T;let d=async({previousCacheEntry:s})=>{try{if(!A&&g&&M&&!s)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await E(r);e.fetchMetrics=x.renderOpts.fetchMetrics;let i=x.renderOpts.pendingWaitUntil;i&&a.waitUntil&&(a.waitUntil(i),i=void 0);let T=x.renderOpts.collectedTags;if(!F)return await (0,N.sendResponse)(G,V,n,x.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,R.toNodeOutgoingHttpHeaders)(n.headers);T&&(t[c.NEXT_CACHE_TAGS_HEADER]=T),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==x.renderOpts.collectedRevalidate&&!(x.renderOpts.collectedRevalidate>=c.INFINITE_CACHE)&&x.renderOpts.collectedRevalidate,s=void 0===x.renderOpts.collectedExpire||x.renderOpts.collectedExpire>=c.INFINITE_CACHE?void 0:x.renderOpts.collectedExpire;return{value:{kind:D.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:s}}}}catch(t){throw(null==s?void 0:s.isStale)&&await _.onRequestError(e,t,{routerKind:"App Router",routePath:n,routeType:"route",revalidateReason:(0,l.getRevalidateReason)({isStaticGeneration:b,isOnDemandRevalidate:g})},!1,f),t}},o=await _.handleResponse({req:e,nextConfig:U,cacheKey:v,routeKind:s.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:S,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:M,responseGenerator:d,waitUntil:a.waitUntil,isMinimalMode:A});if(!F)return null;if((null==o||null==(i=o.value)?void 0:i.kind)!==D.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==o||null==(T=o.value)?void 0:T.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});A||t.setHeader("x-nextjs-cache",g?"REVALIDATED":o.isMiss?"MISS":o.isStale?"STALE":"HIT"),m&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let L=(0,R.fromNodeOutgoingHttpHeaders)(o.value.headers);return A&&F||L.delete(c.NEXT_CACHE_TAGS_HEADER),!o.cacheControl||t.getHeader("Cache-Control")||L.get("Cache-Control")||L.set("Cache-Control",(0,u.getCacheControlHeader)(o.cacheControl)),await (0,N.sendResponse)(G,V,new Response(o.value.body,{headers:L,status:o.value.status||200})),null};$?await T($):await w.withPropagatedContext(e.headers,()=>w.trace(L.BaseServerSpan.handleRequest,{spanName:`${B} ${n}`,kind:i.SpanKind.SERVER,attributes:{"http.method":B,"http.target":e.url}},T))}catch(t){if(t instanceof C.NoFallbackError||await _.onRequestError(e,t,{routerKind:"App Router",routePath:P,routeType:"route",revalidateReason:(0,l.getRevalidateReason)({isStaticGeneration:b,isOnDemandRevalidate:g})},!1,f),F)throw t;return await (0,N.sendResponse)(G,V,new Response(null,{status:500})),null}}e.s(["handler",()=>I,"patchFetch",()=>U,"routeModule",()=>_,"serverHooks",()=>f,"workAsyncStorage",()=>m,"workUnitAsyncStorage",()=>S]),a()}catch(e){a(e)}},!1)];
