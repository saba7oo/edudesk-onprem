module.exports=[5310,e=>e.a(async(t,n)=>{try{var a=e.i(89171),s=e.i(38895),E=e.i(33405),i=e.i(22734),r=t([s]);[s]=r.then?(await r)():r;let d="/tmp/edudesk-update.log",o="/tmp/edudesk-update.lock";async function A(){let{error:e}=await (0,s.requireAuth)(["TENANT_ADMIN"]);if(e)return e;let t=i.default.existsSync(o);return a.NextResponse.json({running:t})}async function T(){let{error:e}=await (0,s.requireAuth)(["TENANT_ADMIN"]);if(e)return e;if(i.default.existsSync(o))return a.NextResponse.json({error:"An update is already in progress"},{status:409});i.default.writeFileSync(d,""),i.default.writeFileSync(o,String(Date.now()));let t=`#!/bin/bash
set -e
LOG="${d}"
LOCK="${o}"
...
`,n="/tmp/edudesk-update-run.sh";return i.default.writeFileSync(n,t,{mode:493}),(0,E.spawn)("bash",[n],{detached:!0,stdio:"ignore"}).unref(),a.NextResponse.json({started:!0})}e.s(["GET",()=>A,"POST",()=>T]),n()}catch(e){n(e)}},!1),25734,e=>e.a(async(t,n)=>{try{var a=e.i(47909),s=e.i(74017),E=e.i(96250),i=e.i(59756),r=e.i(61916),A=e.i(74677),T=e.i(69741),d=e.i(16795),o=e.i(87718),l=e.i(95169),L=e.i(47587),N=e.i(66012),R=e.i(70101),u=e.i(26937),c=e.i(70909),C=e.i(93695);e.i(52474);var D=e.i(220),p=e.i(5310),O=t([p]);[p]=O.then?(await O)():O;let _=new a.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/system/update/route",pathname:"/api/system/update",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/system/update/route.ts",nextConfigOutput:"",userland:p}),{workAsyncStorage:m,workUnitAsyncStorage:S,serverHooks:f}=_;function I(){return(0,E.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:S})}async function U(e,t,n){_.isDev&&(0,i.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let a="/api/system/update/route";a=a.replace(/\/index$/,"")||"/";let E=await _.prepare(e,t,{srcPage:a,multiZoneDraftMode:!1});if(!E)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:p,params:O,nextConfig:I,parsedUrl:U,isDraftMode:m,prerenderManifest:S,routerServerContext:f,isOnDemandRevalidate:g,revalidateOnlyGenerated:h,resolvedPathname:M,clientReferenceManifest:y,serverActionsManifest:k}=E,P=(0,T.normalizeAppPath)(a),F=!!(S.dynamicRoutes[P]||S.routes[M]),v=async()=>((null==f?void 0:f.render404)?await f.render404(e,t,U,!1):t.end("This page could not be found"),null);if(F&&!m){let e=!!S.routes[M],t=S.dynamicRoutes[P];if(t&&!1===t.fallback&&!e){if(I.experimental.adapterPath)return await v();throw new C.NoFallbackError}}let H=null;!F||_.isDev||m||(H=M,H="/index"===H?"/":H);let b=!0===_.isDev||!F,q=F&&!b;k&&y&&(0,A.setManifestsSingleton)({page:a,clientReferenceManifest:y,serverActionsManifest:k});let B=e.method||"GET",w=(0,r.getTracer)(),$=w.getActiveScopeSpan(),x={params:O,prerenderManifest:S,renderOpts:{experimental:{authInterrupts:!!I.experimental.authInterrupts},cacheComponents:!!I.cacheComponents,supportsDynamicResponse:b,incrementalCache:(0,i.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:I.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,n,a,s)=>_.onRequestError(e,t,a,s,f)},sharedContext:{buildId:p}},V=new d.NodeNextRequest(e),G=new d.NodeNextResponse(t),X=o.NextRequestAdapter.fromNodeNextRequest(V,(0,o.signalFromNodeResponse)(t));try{let E=async e=>_.handle(X,x).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let n=w.getRootSpanAttributes();if(!n)return;if(n.get("next.span_type")!==l.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${n.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let s=n.get("next.route");if(s){let t=`${B} ${s}`;e.setAttributes({"next.route":s,"http.route":s,"next.span_name":t}),e.updateName(t)}else e.updateName(`${B} ${a}`)}),A=!!(0,i.getRequestMeta)(e,"minimalMode"),T=async i=>{var r,T;let d=async({previousCacheEntry:s})=>{try{if(!A&&g&&h&&!s)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let a=await E(i);e.fetchMetrics=x.renderOpts.fetchMetrics;let r=x.renderOpts.pendingWaitUntil;r&&n.waitUntil&&(n.waitUntil(r),r=void 0);let T=x.renderOpts.collectedTags;if(!F)return await (0,N.sendResponse)(V,G,a,x.renderOpts.pendingWaitUntil),null;{let e=await a.blob(),t=(0,R.toNodeOutgoingHttpHeaders)(a.headers);T&&(t[c.NEXT_CACHE_TAGS_HEADER]=T),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let n=void 0!==x.renderOpts.collectedRevalidate&&!(x.renderOpts.collectedRevalidate>=c.INFINITE_CACHE)&&x.renderOpts.collectedRevalidate,s=void 0===x.renderOpts.collectedExpire||x.renderOpts.collectedExpire>=c.INFINITE_CACHE?void 0:x.renderOpts.collectedExpire;return{value:{kind:D.CachedRouteKind.APP_ROUTE,status:a.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:n,expire:s}}}}catch(t){throw(null==s?void 0:s.isStale)&&await _.onRequestError(e,t,{routerKind:"App Router",routePath:a,routeType:"route",revalidateReason:(0,L.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:g})},!1,f),t}},o=await _.handleResponse({req:e,nextConfig:I,cacheKey:H,routeKind:s.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:S,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:h,responseGenerator:d,waitUntil:n.waitUntil,isMinimalMode:A});if(!F)return null;if((null==o||null==(r=o.value)?void 0:r.kind)!==D.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==o||null==(T=o.value)?void 0:T.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});A||t.setHeader("x-nextjs-cache",g?"REVALIDATED":o.isMiss?"MISS":o.isStale?"STALE":"HIT"),m&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let l=(0,R.fromNodeOutgoingHttpHeaders)(o.value.headers);return A&&F||l.delete(c.NEXT_CACHE_TAGS_HEADER),!o.cacheControl||t.getHeader("Cache-Control")||l.get("Cache-Control")||l.set("Cache-Control",(0,u.getCacheControlHeader)(o.cacheControl)),await (0,N.sendResponse)(V,G,new Response(o.value.body,{headers:l,status:o.value.status||200})),null};$?await T($):await w.withPropagatedContext(e.headers,()=>w.trace(l.BaseServerSpan.handleRequest,{spanName:`${B} ${a}`,kind:r.SpanKind.SERVER,attributes:{"http.method":B,"http.target":e.url}},T))}catch(t){if(t instanceof C.NoFallbackError||await _.onRequestError(e,t,{routerKind:"App Router",routePath:P,routeType:"route",revalidateReason:(0,L.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:g})},!1,f),F)throw t;return await (0,N.sendResponse)(V,G,new Response(null,{status:500})),null}}e.s(["handler",()=>U,"patchFetch",()=>I,"routeModule",()=>_,"serverHooks",()=>f,"workAsyncStorage",()=>m,"workUnitAsyncStorage",()=>S]),n()}catch(e){n(e)}},!1)];
