module.exports=[5310,e=>e.a(async(t,a)=>{try{var n=e.i(89171),E=e.i(38895),s=e.i(33405),i=e.i(22734),r=t([E]);[E]=r.then?(await r)():r;let d="/tmp/edudesk-update.log",o="/tmp/edudesk-update.lock";async function A(){let{error:e}=await (0,E.requireAuth)(["TENANT_ADMIN"]);if(e)return e;let t=i.default.existsSync(o);return n.NextResponse.json({running:t})}async function T(){let{error:e}=await (0,E.requireAuth)(["TENANT_ADMIN"]);if(e)return e;if(i.default.existsSync(o))return n.NextResponse.json({error:"An update is already in progress"},{status:409});i.default.writeFileSync(d,""),i.default.writeFileSync(o,String(Date.now()));let t=`#!/bin/bash
set -e
LOG="${d}"
LOCK="${o}"
