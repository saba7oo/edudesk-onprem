module.exports=[5310,e=>e.a(async(t,a)=>{try{var n=e.i(89171),E=e.i(38895),s=e.i(33405),r=e.i(22734),i=t([E]);[E]=i.then?(await i)():i;let T="/tmp/edudesk-update.log",o="/tmp/edudesk-update.lock";async function A(){let{error:e}=await (0,E.requireAuth)(["TENANT_ADMIN"]);if(e)return e;let t=r.default.existsSync(o);return n.NextResponse.json({running:t})}async function d(){let{error:e}=await (0,E.requireAuth)(["TENANT_ADMIN"]);if(e)return e;if(r.default.existsSync(o))return n.NextResponse.json({error:"An update is already in progress"},{status:409});r.default.writeFileSync(T,""),r.default.writeFileSync(o,String(Date.now()));let t=`#!/bin/bash
set -e
LOG="${T}"
LOCK="${o}"
...
log "RESTARTING"
rm -f "$LOCK"
# Use systemd-run to restart from outside the service cgroup — ensures the restart
# fires even after systemd kills this script as part of the edudesk cgroup teardown
systemd-run --on-active=3 /bin/systemctl restart edudesk
`,a="/tmp/edudesk-update-run.sh";return r.default.writeFileSync(a,t,{mode:493}),(0,s.spawn)("bash",[a],{detached:!0,stdio:"ignore"}).unref(),n.NextResponse.json({started:!0})}e.s(["GET",()=>A,"POST",()=>d]),a()}catch(e){a(e)}},!1),25734,e=>e.a(async(t,a)=>{try{var n=e.i(47909),E=e.i(74017),s=e.i(96250),r=e.i(59756),i=e.i(61916),A=e.i(74677),d=e.i(69741),T=e.i(16795),o=e.i(87718),l=e.i(95169),N=e.i(47587),L=e.i(66012),u=e.i(70101),R=e.i(26937),c=e.i(70909),p=e.i(93695);e.i(52474);var C=e.i(220),I=e.i(5310),O=t([I]);[I]=O.then?(await O)():O;let U=new n.AppRouteRouteModule({definition:{kind:E.RouteKind.APP_ROUTE,page:"/api/system/update/route",pathname:"/api/system/update",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/system/update/route.ts",nextConfigOutput:"",userland:I}),{workAsyncStorage:m,workUnitAsyncStorage:S,serverHooks:f}=U;function D(){return(0,s.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:S})}async function _(e,t,a){U.isDev&&(0,r.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/system/update/route";n=n.replace(/\/index$/,"")||"/";let s=await U.prepare(e,t,{srcPage:n,multiZoneDraftMode:!1});if(!s)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:I,params:O,nextConfig:D,parsedUrl:_,isDraftMode:m,prerenderManifest:S,routerServerContext:f,isOnDemandRevalidate:g,revalidateOnlyGenerated:M,resolvedPathname:h,clientReferenceManifest:y,serverActionsManifest:P}=s,k=(0,d.normalizeAppPath)(n),F=!!(S.dynamicRoutes[k]||S.routes[h]),v=async()=>((null==f?void 0:f.render404)?await f.render404(e,t,_,!1):t.end("This page could not be found"),null);if(F&&!m){let e=!!S.routes[h],t=S.dynamicRoutes[k];if(t&&!1===t.fallback&&!e){if(D.experimental.adapterPath)return await v();throw new p.NoFallbackError}}let H=null;!F||U.isDev||m||(H=h,H="/index"===H?"/":H);let q=!0===U.isDev||!F,b=F&&!q;P&&y&&(0,A.setManifestsSingleton)({page:n,clientReferenceManifest:y,serverActionsManifest:P});let B=e.method||"GET",x=(0,i.getTracer)(),w=x.getActiveScopeSpan(),$={params:O,prerenderManifest:S,renderOpts:{experimental:{authInterrupts:!!D.experimental.authInterrupts},cacheComponents:!!D.cacheComponents,supportsDynamicResponse:q,incrementalCache:(0,r.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:D.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,n,E)=>U.onRequestError(e,t,n,E,f)},sharedContext:{buildId:I}},V=new T.NodeNextRequest(e),G=new T.NodeNextResponse(t),K=o.NextRequestAdapter.fromNodeNextRequest(V,(0,o.signalFromNodeResponse)(t));try{let s=async e=>U.handle(K,$).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=x.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==l.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let E=a.get("next.route");if(E){let t=`${B} ${E}`;e.setAttributes({"next.route":E,"http.route":E,"next.span_name":t}),e.updateName(t)}else e.updateName(`${B} ${n}`)}),A=!!(0,r.getRequestMeta)(e,"minimalMode"),d=async r=>{var i,d;let T=async({previousCacheEntry:E})=>{try{if(!A&&g&&M&&!E)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await s(r);e.fetchMetrics=$.renderOpts.fetchMetrics;let i=$.renderOpts.pendingWaitUntil;i&&a.waitUntil&&(a.waitUntil(i),i=void 0);let d=$.renderOpts.collectedTags;if(!F)return await (0,L.sendResponse)(V,G,n,$.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,u.toNodeOutgoingHttpHeaders)(n.headers);d&&(t[c.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==$.renderOpts.collectedRevalidate&&!($.renderOpts.collectedRevalidate>=c.INFINITE_CACHE)&&$.renderOpts.collectedRevalidate,E=void 0===$.renderOpts.collectedExpire||$.renderOpts.collectedExpire>=c.INFINITE_CACHE?void 0:$.renderOpts.collectedExpire;return{value:{kind:C.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:E}}}}catch(t){throw(null==E?void 0:E.isStale)&&await U.onRequestError(e,t,{routerKind:"App Router",routePath:n,routeType:"route",revalidateReason:(0,N.getRevalidateReason)({isStaticGeneration:b,isOnDemandRevalidate:g})},!1,f),t}},o=await U.handleResponse({req:e,nextConfig:D,cacheKey:H,routeKind:E.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:S,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:M,responseGenerator:T,waitUntil:a.waitUntil,isMinimalMode:A});if(!F)return null;if((null==o||null==(i=o.value)?void 0:i.kind)!==C.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==o||null==(d=o.value)?void 0:d.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});A||t.setHeader("x-nextjs-cache",g?"REVALIDATED":o.isMiss?"MISS":o.isStale?"STALE":"HIT"),m&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let l=(0,u.fromNodeOutgoingHttpHeaders)(o.value.headers);return A&&F||l.delete(c.NEXT_CACHE_TAGS_HEADER),!o.cacheControl||t.getHeader("Cache-Control")||l.get("Cache-Control")||l.set("Cache-Control",(0,R.getCacheControlHeader)(o.cacheControl)),await (0,L.sendResponse)(V,G,new Response(o.value.body,{headers:l,status:o.value.status||200})),null};w?await d(w):await x.withPropagatedContext(e.headers,()=>x.trace(l.BaseServerSpan.handleRequest,{spanName:`${B} ${n}`,kind:i.SpanKind.SERVER,attributes:{"http.method":B,"http.target":e.url}},d))}catch(t){if(t instanceof p.NoFallbackError||await U.onRequestError(e,t,{routerKind:"App Router",routePath:k,routeType:"route",revalidateReason:(0,N.getRevalidateReason)({isStaticGeneration:b,isOnDemandRevalidate:g})},!1,f),F)throw t;return await (0,L.sendResponse)(V,G,new Response(null,{status:500})),null}}e.s(["handler",()=>_,"patchFetch",()=>D,"routeModule",()=>U,"serverHooks",()=>f,"workAsyncStorage",()=>m,"workUnitAsyncStorage",()=>S]),a()}catch(e){a(e)}},!1)];
