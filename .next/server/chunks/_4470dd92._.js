...
# From here on, NEVER abort the script: migrations are idempotent and each step
# is individually guarded. 'prisma migrate status' returns non-zero on OnPrem
# (schema is kept in sync via run_sql, not Prisma's migration history), and with
# 'set -e' that aborted the whole run BEFORE the restart block — leaving the new
# build on disk but the old one still running. The restart MUST always be reached.
set +e
...
# Wrap the stop/sleep/start in 'sh -c' — systemd-run runs a single command and does NOT
# treat ';' as a separator, so the chained form must go through a shell.
if [ $RESTART_SCHEDULED -eq 0 ] && command -v systemd-run >/dev/null 2>&1; then
  if systemd-run --no-ask-password --on-active=8 /bin/sh -c 'systemctl stop edudesk; sleep 3; systemctl start edudesk' >> "$LOG" 2>&1; then
...
`,n="/tmp/edudesk-update-run.sh";return A.default.writeFileSync(n,t,{mode:493}),(0,s.spawn)("bash",[n],{detached:!0,stdio:"ignore"}).unref(),a.NextResponse.json({started:!0})}e.s(["GET",()=>T,"POST",()=>i]),n()}catch(e){n(e)}},!1),25734,e=>e.a(async(t,n)=>{try{var a=e.i(47909),E=e.i(74017),s=e.i(96250),A=e.i(59756),r=e.i(61916),T=e.i(74677),i=e.i(69741),d=e.i(16795),L=e.i(87718),o=e.i(95169),N=e.i(47587),l=e.i(66012),R=e.i(70101),u=e.i(26937),c=e.i(70909),C=e.i(93695);e.i(52474);var D=e.i(220),I=e.i(5310),_=t([I]);[I]=_.then?(await _)():_;let p=new a.AppRouteRouteModule({definition:{kind:E.RouteKind.APP_ROUTE,page:"/api/system/update/route",pathname:"/api/system/update",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/system/update/route.ts",nextConfigOutput:"",userland:I}),{workAsyncStorage:m,workUnitAsyncStorage:S,serverHooks:f}=p;function O(){return(0,s.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:S})}async function U(e,t,n){p.isDev&&(0,A.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let a="/api/system/update/route";a=a.replace(/\/index$/,"")||"/";let s=await p.prepare(e,t,{srcPage:a,multiZoneDraftMode:!1});if(!s)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:I,params:_,nextConfig:O,parsedUrl:U,isDraftMode:m,prerenderManifest:S,routerServerContext:f,isOnDemandRevalidate:g,revalidateOnlyGenerated:M,resolvedPathname:h,clientReferenceManifest:k,serverActionsManifest:y}=s,F=(0,i.normalizeAppPath)(a),P=!!(S.dynamicRoutes[F]||S.routes[h]),H=async()=>((null==f?void 0:f.render404)?await f.render404(e,t,U,!1):t.end("This page could not be found"),null);if(P&&!m){let e=!!S.routes[h],t=S.dynamicRoutes[F];if(t&&!1===t.fallback&&!e){if(O.experimental.adapterPath)return await H();throw new C.NoFallbackError}}let v=null;!P||p.isDev||m||(v=h,v="/index"===v?"/":v);let b=!0===p.isDev||!P,q=P&&!b;y&&k&&(0,T.setManifestsSingleton)({page:a,clientReferenceManifest:k,serverActionsManifest:y});let B=e.method||"GET",w=(0,r.getTracer)(),x=w.getActiveScopeSpan(),V={params:_,prerenderManifest:S,renderOpts:{experimental:{authInterrupts:!!O.experimental.authInterrupts},cacheComponents:!!O.cacheComponents,supportsDynamicResponse:b,incrementalCache:(0,A.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:O.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,n,a,E)=>p.onRequestError(e,t,a,E,f)},sharedContext:{buildId:I}},$=new d.NodeNextRequest(e),G=new d.NodeNextResponse(t),X=L.NextRequestAdapter.fromNodeNextRequest($,(0,L.signalFromNodeResponse)(t));try{let s=async e=>p.handle(X,V).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let n=w.getRootSpanAttributes();if(!n)return;if(n.get("next.span_type")!==o.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${n.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let E=n.get("next.route");if(E){let t=`${B} ${E}`;e.setAttributes({"next.route":E,"http.route":E,"next.span_name":t}),e.updateName(t)}else e.updateName(`${B} ${a}`)}),T=!!(0,A.getRequestMeta)(e,"minimalMode"),i=async A=>{var r,i;let d=async({previousCacheEntry:E})=>{try{if(!T&&g&&M&&!E)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let a=await s(A);e.fetchMetrics=V.renderOpts.fetchMetrics;let r=V.renderOpts.pendingWaitUntil;r&&n.waitUntil&&(n.waitUntil(r),r=void 0);let i=V.renderOpts.collectedTags;if(!P)return await (0,l.sendResponse)($,G,a,V.renderOpts.pendingWaitUntil),null;{let e=await a.blob(),t=(0,R.toNodeOutgoingHttpHeaders)(a.headers);i&&(t[c.NEXT_CACHE_TAGS_HEADER]=i),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let n=void 0!==V.renderOpts.collectedRevalidate&&!(V.renderOpts.collectedRevalidate>=c.INFINITE_CACHE)&&V.renderOpts.collectedRevalidate,E=void 0===V.renderOpts.collectedExpire||V.renderOpts.collectedExpire>=c.INFINITE_CACHE?void 0:V.renderOpts.collectedExpire;return{value:{kind:D.CachedRouteKind.APP_ROUTE,status:a.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:n,expire:E}}}}catch(t){throw(null==E?void 0:E.isStale)&&await p.onRequestError(e,t,{routerKind:"App Router",routePath:a,routeType:"route",revalidateReason:(0,N.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:g})},!1,f),t}},L=await p.handleResponse({req:e,nextConfig:O,cacheKey:v,routeKind:E.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:S,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:M,responseGenerator:d,waitUntil:n.waitUntil,isMinimalMode:T});if(!P)return null;if((null==L||null==(r=L.value)?void 0:r.kind)!==D.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==L||null==(i=L.value)?void 0:i.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});T||t.setHeader("x-nextjs-cache",g?"REVALIDATED":L.isMiss?"MISS":L.isStale?"STALE":"HIT"),m&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let o=(0,R.fromNodeOutgoingHttpHeaders)(L.value.headers);return T&&P||o.delete(c.NEXT_CACHE_TAGS_HEADER),!L.cacheControl||t.getHeader("Cache-Control")||o.get("Cache-Control")||o.set("Cache-Control",(0,u.getCacheControlHeader)(L.cacheControl)),await (0,l.sendResponse)($,G,new Response(L.value.body,{headers:o,status:L.value.status||200})),null};x?await i(x):await w.withPropagatedContext(e.headers,()=>w.trace(o.BaseServerSpan.handleRequest,{spanName:`${B} ${a}`,kind:r.SpanKind.SERVER,attributes:{"http.method":B,"http.target":e.url}},i))}catch(t){if(t instanceof C.NoFallbackError||await p.onRequestError(e,t,{routerKind:"App Router",routePath:F,routeType:"route",revalidateReason:(0,N.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:g})},!1,f),P)throw t;return await (0,l.sendResponse)($,G,new Response(null,{status:500})),null}}e.s(["handler",()=>U,"patchFetch",()=>O,"routeModule",()=>p,"serverHooks",()=>f,"workAsyncStorage",()=>m,"workUnitAsyncStorage",()=>S]),n()}catch(e){n(e)}},!1)];
