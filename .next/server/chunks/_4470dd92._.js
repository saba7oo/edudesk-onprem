module.exports=[5310,e=>e.a(async(t,n)=>{try{var E=e.i(89171),a=e.i(38895),s=e.i(33405),A=e.i(22734),T=t([a]);[a]=T.then?(await T)():T;let d="/tmp/edudesk-update.log",L="/tmp/edudesk-update.lock";async function r(){let{error:e}=await (0,a.requireAuth)(["TENANT_ADMIN"]);if(e)return e;let t=A.default.existsSync(L);return E.NextResponse.json({running:t})}async function i(){let{error:e}=await (0,a.requireAuth)(["TENANT_ADMIN"]);if(e)return e;if(A.default.existsSync(L))return E.NextResponse.json({error:"An update is already in progress"},{status:409});A.default.writeFileSync(d,""),A.default.writeFileSync(L,String(Date.now()));let t=`#!/bin/bash
set -e
LOG="${d}"
LOCK="${L}"
...
`,n="/tmp/edudesk-update-run.sh";return A.default.writeFileSync(n,t,{mode:493}),(0,s.spawn)("bash",[n],{detached:!0,stdio:"ignore"}).unref(),E.NextResponse.json({started:!0})}e.s(["GET",()=>r,"POST",()=>i]),n()}catch(e){n(e)}},!1),25734,e=>e.a(async(t,n)=>{try{var E=e.i(47909),a=e.i(74017),s=e.i(96250),A=e.i(59756),T=e.i(61916),r=e.i(74677),i=e.i(69741),d=e.i(16795),L=e.i(87718),N=e.i(95169),o=e.i(47587),R=e.i(66012),l=e.i(70101),u=e.i(26937),c=e.i(70909),C=e.i(93695);e.i(52474);var D=e.i(220),I=e.i(5310),_=t([I]);[I]=_.then?(await _)():_;let p=new E.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/system/update/route",pathname:"/api/system/update",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/system/update/route.ts",nextConfigOutput:"",userland:I}),{workAsyncStorage:S,workUnitAsyncStorage:m,serverHooks:f}=p;function O(){return(0,s.patchFetch)({workAsyncStorage:S,workUnitAsyncStorage:m})}async function U(e,t,n){p.isDev&&(0,A.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let E="/api/system/update/route";E=E.replace(/\/index$/,"")||"/";let s=await p.prepare(e,t,{srcPage:E,multiZoneDraftMode:!1});if(!s)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:I,params:_,nextConfig:O,parsedUrl:U,isDraftMode:S,prerenderManifest:m,routerServerContext:f,isOnDemandRevalidate:g,revalidateOnlyGenerated:M,resolvedPathname:h,clientReferenceManifest:k,serverActionsManifest:y}=s,F=(0,i.normalizeAppPath)(E),P=!!(m.dynamicRoutes[F]||m.routes[h]),H=async()=>((null==f?void 0:f.render404)?await f.render404(e,t,U,!1):t.end("This page could not be found"),null);if(P&&!S){let e=!!m.routes[h],t=m.dynamicRoutes[F];if(t&&!1===t.fallback&&!e){if(O.experimental.adapterPath)return await H();throw new C.NoFallbackError}}let v=null;!P||p.isDev||S||(v=h,v="/index"===v?"/":v);let b=!0===p.isDev||!P,q=P&&!b;y&&k&&(0,r.setManifestsSingleton)({page:E,clientReferenceManifest:k,serverActionsManifest:y});let B=e.method||"GET",w=(0,T.getTracer)(),x=w.getActiveScopeSpan(),V={params:_,prerenderManifest:m,renderOpts:{experimental:{authInterrupts:!!O.experimental.authInterrupts},cacheComponents:!!O.cacheComponents,supportsDynamicResponse:b,incrementalCache:(0,A.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:O.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,n,E,a)=>p.onRequestError(e,t,E,a,f)},sharedContext:{buildId:I}},$=new d.NodeNextRequest(e),G=new d.NodeNextResponse(t),X=L.NextRequestAdapter.fromNodeNextRequest($,(0,L.signalFromNodeResponse)(t));try{let s=async e=>p.handle(X,V).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let n=w.getRootSpanAttributes();if(!n)return;if(n.get("next.span_type")!==N.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${n.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=n.get("next.route");if(a){let t=`${B} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t)}else e.updateName(`${B} ${E}`)}),r=!!(0,A.getRequestMeta)(e,"minimalMode"),i=async A=>{var T,i;let d=async({previousCacheEntry:a})=>{try{if(!r&&g&&M&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let E=await s(A);e.fetchMetrics=V.renderOpts.fetchMetrics;let T=V.renderOpts.pendingWaitUntil;T&&n.waitUntil&&(n.waitUntil(T),T=void 0);let i=V.renderOpts.collectedTags;if(!P)return await (0,R.sendResponse)($,G,E,V.renderOpts.pendingWaitUntil),null;{let e=await E.blob(),t=(0,l.toNodeOutgoingHttpHeaders)(E.headers);i&&(t[c.NEXT_CACHE_TAGS_HEADER]=i),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let n=void 0!==V.renderOpts.collectedRevalidate&&!(V.renderOpts.collectedRevalidate>=c.INFINITE_CACHE)&&V.renderOpts.collectedRevalidate,a=void 0===V.renderOpts.collectedExpire||V.renderOpts.collectedExpire>=c.INFINITE_CACHE?void 0:V.renderOpts.collectedExpire;return{value:{kind:D.CachedRouteKind.APP_ROUTE,status:E.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:n,expire:a}}}}catch(t){throw(null==a?void 0:a.isStale)&&await p.onRequestError(e,t,{routerKind:"App Router",routePath:E,routeType:"route",revalidateReason:(0,o.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:g})},!1,f),t}},L=await p.handleResponse({req:e,nextConfig:O,cacheKey:v,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:m,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:M,responseGenerator:d,waitUntil:n.waitUntil,isMinimalMode:r});if(!P)return null;if((null==L||null==(T=L.value)?void 0:T.kind)!==D.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==L||null==(i=L.value)?void 0:i.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});r||t.setHeader("x-nextjs-cache",g?"REVALIDATED":L.isMiss?"MISS":L.isStale?"STALE":"HIT"),S&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let N=(0,l.fromNodeOutgoingHttpHeaders)(L.value.headers);return r&&P||N.delete(c.NEXT_CACHE_TAGS_HEADER),!L.cacheControl||t.getHeader("Cache-Control")||N.get("Cache-Control")||N.set("Cache-Control",(0,u.getCacheControlHeader)(L.cacheControl)),await (0,R.sendResponse)($,G,new Response(L.value.body,{headers:N,status:L.value.status||200})),null};x?await i(x):await w.withPropagatedContext(e.headers,()=>w.trace(N.BaseServerSpan.handleRequest,{spanName:`${B} ${E}`,kind:T.SpanKind.SERVER,attributes:{"http.method":B,"http.target":e.url}},i))}catch(t){if(t instanceof C.NoFallbackError||await p.onRequestError(e,t,{routerKind:"App Router",routePath:F,routeType:"route",revalidateReason:(0,o.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:g})},!1,f),P)throw t;return await (0,R.sendResponse)($,G,new Response(null,{status:500})),null}}e.s(["handler",()=>U,"patchFetch",()=>O,"routeModule",()=>p,"serverHooks",()=>f,"workAsyncStorage",()=>S,"workUnitAsyncStorage",()=>m]),n()}catch(e){n(e)}},!1)];
